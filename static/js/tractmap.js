...
let dataLayers = L.layerGroup([lessHS, lessNinth]);
...
// // Create global variable for dataset
// let dataset;
...
// // Function to assign tract color by high % of
// // factors (e.g., high percentage, low educational attainment, )
//   function getColor(d) {
//     return d > 30 ? '#88419d' :
//     d > 15  ? '##8c96c6' :
//     // d > 10  ? '#8c96c6' :
...
//                 fillColor: getColor(feature.properties.LESS_HS),
//                 fillOpacity: 0.7
//                 // BLACK, LATINO, LESS_NINTH, LESS_HS
//             };
//         },
...
//             // layer.bindPopup("<h1>" + feature.properties.GEOID + "</h1>");  
//             layer.bindPopup("<h3>" + feature.properties.TRACT_NAME + 
//             "</h3><hr><p>% Less than 9th Grade: " + feature.properties.LESS_NINTH + 
//             "</p><p>% Less than High School: " + feature.properties.LESS_HS + 
//             "</p><p>% Black: " + feature.properties.BLACK + 
...
//         // loop through data generate legend label
//         for (var i = 0; i < prctpop.length; i++) {
//             div.innerHTML +=
//                 '<i style="background:' + getColor(prctpop[i] + 1) + '"></i> ' +
//                 prctpop[i] + (prctpop[i + 1] ? '&ndash;' + prctpop[i + 1] + '<br>' : '+');
//         }
